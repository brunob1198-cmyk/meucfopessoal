      ...
      <div className="min-h-screen flex w-full">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <header className="h-14 flex items-center border-b border-border px-4 shrink-0 text-secondary-foreground bg-muted-foreground relative">
            ...
            <LogoUpload />
            <div className="absolute left-1/2 -translate-x-1/2 text-sm font-semibold tracking-[0.25em] uppercase text-primary-foreground/80 whitespace-nowrap hidden sm:block">
